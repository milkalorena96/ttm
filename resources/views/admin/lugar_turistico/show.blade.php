    ...
    <div id="layoutSidenav_content">
        <main class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="float-left">
                                <span class="card-title">Nombre: <strong>{{ $lugar->nombre }}</strong></span>
                            </div>
                            <a href="{{route('lugares.index')}}" class="btn btn-danger ml-auto float-right">Cerrar</a>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <strong>Departamento: </strong>{{$lugar->departamento}}&nbsp;|
                                <strong>Provincia: </strong>{{$lugar->provincia}}&nbsp;|
                                <strong>Distrito: </strong>{{$lugar->distrito}}
                            </div>
                            <div class="form-group">
                                <strong>Descripcion:</strong>
                                <textarea class="form-control" rows="2" readonly>{{ $lugar->description }}</textarea>
                            </div>
                        </div>
                        <div class="card text-center">
                            <p>Subir fotos para el lugar turistico <strong>{{ $lugar->nombre }}</strong> </p>
                            <div class="container-fluid">
                                <form enctype="multipart/form-data" method="post" action="{{route('AgregarFotosLugar')}}">
            ...
            <div class="row">
                <div class="col-md-12 ">
                    <div class="card text-center">
                    <p>Fotos de: <strong>{{ $lugar->nombre }}</strong> </p>
                        <div class="card-body">
                            <section id="exemple" class="container">
                                <div class="wrap">
                                    ...
                                    @foreach($lugar->fotos as $foto)
                                        <li class="box">
                                            <img src="/img/lugar_turistico/fotos/{{$foto->ruta}}" alt="Placeholder image">

                                            <div class="input-group">
                                                {!!Form::open(['method'=>'DELETE','route'=>['eliminarFotoLugar',$foto->id],'class'=>'formEliminar' ])!!}
                                                {!! Form::submit('Eliminar',['class'=>'btn btn-sm btn-danger']) !!}
                                                <a href="/img/lugar_turistico/fotos/{{$foto->ruta}}" target="_blank" class="btn btn-sm btn-primary">Ver</a>
                                                {!! Form::close() !!}
                                            </div>
                                        </li>
                                        @endforeach
