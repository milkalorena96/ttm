        ...
        <main class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    @endif
                    <a href="{{route('restaurante.create')}}" class="btn btn-primary float-right">NUEVO</a>
                    <div>
                        ...
                        <table class="table table-responsive table-hover">
                            ...
                            <tbody>
                                @forelse ($restaurantes as $item)
                                <tr>
                                    <td>{{$item->ruc}}</td>
                                    <td>{{$item->nombre}}</td>
                                    <td>{{$item->lugar->nombre}}</td>
                                    <td>
                                        <a href="/admin/restaurante/{{$item->slug}}" class="btn btn-sm btn-primary"><i class="fa fa-fw fa-eye"></i>&nbsp;Ver</a>
                                        <a href="/admin/restaurante/{{$item->slug}}/edit" class="btn btn-sm btn-warning">Editar</a>
